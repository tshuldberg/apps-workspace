/**
 * Composition Phase 1 spine (block registry + layout resolution). Proves:
...
import {
  ...
  validateBlockConfig,
} from '../(root)/data/block-registry-core';
import {
  channelBlockStack,
  draftLayoutProblems,
  resolveActiveLayout,
  resolveBlockStack,
} from '../(root)/data/community-layout-core';
import { COMMUNITY_SYNC_POLICY } from '../(root)/data/community-core';
