// Plan 38 Phase 1b (amendment D.2): resolveActiveTheme priority matrix. The ONE
// per-community theme choke point is pure and total. Priority: high-contrast beats
// a community theme beats accent-only; member mode 'mine' ignores the community
...
describe('resolveActiveTheme priority matrix', () => {
