...
// block-registry-core. This is the MOBILE source of truth;
// apps/meerkat-web/src/lib/canvas-node-registry-core.ts is a byte-identical
// twin (only this header differs), parity-locked by check-meerkat-parity.mjs.
//
