// Plan 25 WP-25G: the device-local call store (call_ tables).
//
...
// (sync-core.ts): because call_ resolves to no module under the real prefix
...
// Replay floor for inbound call signals: seen nonces persist across an app
// restart so a captured signal cannot re-ring after a relaunch inside its
