// dm-provider-core.ts (Plan 21 Phase 4): the pure, injectable-dependency core
// behind SyncProvider's DM send/receipt methods and the dmMessage/dmReceipt
// drain handlers. Mirrors the established pattern (file-request-core.ts,
