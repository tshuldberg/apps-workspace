// Plan 21 Phase 5: pure mapping between the local dm_ store and the shared chat
// kit + the conversation-list rows. The screens wire providers + effects; every
// honest decision worth testing lives here so the node-only mobile vitest covers
// it without a React harness. No provider imports beyond the pure chat-kit core.
//
...
import { formatClockTime, type ChatKitMessage } from '../components/chat/chat-kit-core';
import {
  ensureDmTables,
  getDmConversation,
