...
// MEDIA_TYPE_REGISTRY. This is the MOBILE source of truth;
// apps/meerkat-web/src/lib/block-registry-core.ts is a byte-identical twin
// (only this header differs), parity-locked by scripts/check-meerkat-parity.mjs.
//
