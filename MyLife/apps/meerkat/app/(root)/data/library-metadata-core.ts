// Plan 38 Phase 0 (amendment A.2): the media-type registry + pure library
// validators. This is the MOBILE source of truth; apps/meerkat-web/src/lib/
// library-metadata-core.ts is a byte-identical twin (only this header differs),
