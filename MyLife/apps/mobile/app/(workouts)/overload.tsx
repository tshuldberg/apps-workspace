          ...
          {suggestionRows.map((item) => {
            ...
            return (
              <View key={item.exercise.id} style={styles.suggestionRow}>
                <View style={[styles.suggestionDot, { backgroundColor: applied ? WK_CATEGORY_COLORS.recovery : WK_ACCENT_LIGHT }]} />
      ...
      <Modal visible={showEditor} animationType="slide" transparent>
        <View style={styles.modalScrim}>
          <View style={styles.modalCard}>
            ...
            <WorkoutPrimaryButton label="Save Rule" icon="check_circle" onPress={saveRule} />
            {draft.id ? (
