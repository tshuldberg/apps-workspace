    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <Pressable
        onPress={() => {
          ...
          router.push(`/(workouts)/builder?focus=${type}`);
        }}
        style={[styles.btn, styles.btnPrimary]}
      >
        <Text variant="label" color={colors.background}>Suggest Workout</Text>
      </Pressable>
    </ScrollView>
  );
}
...
const styles = StyleSheet.create({
  ...
  suggestionText: { fontSize: 18, lineHeight: 24, color: ACCENT, marginTop: 4 },
