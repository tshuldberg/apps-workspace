  ...
  const finalizeSession = useCallback(
    async (finalStatus: PlayerStatus) => {
      ...
      try {
        ...
        router.replace({
          pathname: '/(workouts)/save-workout',
          params: {
      ...
      <WorkoutPhaseScreen>
        ...
        <WorkoutPhaseHeader
          ...
          right={(
            <Pressable
              onPress={() =>
                router.push(`/(workouts)/share-workout?sessionId=${detail.session.id}` as never)
              }
        ...
        <View style={styles.liveBody}>
          ...
          >
            ...
            <View style={styles.actionStrip}>
              <Pressable onPress={handleSetTypePress} style={styles.setTypePill}>
                <RNText
                  style={[
                    styles.setTypeText,
