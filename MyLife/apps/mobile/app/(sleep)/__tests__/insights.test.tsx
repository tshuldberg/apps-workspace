...
import SleepInsightsScreen from '../insights';
...
describe('SleepInsightsScreen', () => {
  ...
  it('renders the full insights dashboard when the selected range has 14+ nights', () => {
    render(<SleepInsightsScreen />);
  ...
  it('shows progress copy before 7 nights are available', () => {
