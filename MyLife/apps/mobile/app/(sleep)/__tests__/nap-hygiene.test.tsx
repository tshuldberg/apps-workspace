...
import SleepHygieneScreen from '../hygiene';
import SleepNapHistoryScreen from '../nap/history';
import SleepNapLogScreen from '../nap/log';
...
describe('MySleep nap and hygiene screens', () => {
  beforeEach(() => {
    vi.useFakeTimers();
  ...
  it('renders the quick nap log flow', () => {
    render(<SleepNapLogScreen />);
  ...
  it('renders nap history metrics and impact insight', () => {
    render(<SleepNapHistoryScreen />);

    expect(screen.getByText('Nap History')).toBeInTheDocument();
  ...
  it('renders the hygiene checklist with auto-filled practice data', () => {
    render(<SleepHygieneScreen />);
    ...
    expect(screen.getByText('Configured practices')).toBeInTheDocument();
  });
});
