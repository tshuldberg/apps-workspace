...
export default function PaymentsWithdrawScreen() {
  const router = useRouter();
  const viewModel = useMemo(
    () => buildPaymentsFundingFlowViewModel(createFundingDemoSnapshot('withdraw')),
    [],
  );
    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        ...
        <View style={styles.headerText}>
          ...
          <Text style={styles.subtitle}>Payout intents keep pending, returned, and settled states explicit</Text>
        </View>
      </View>

      <PaymentGlassCard eyebrow="Destination" title={viewModel.selectedAccount?.displayName ?? 'Select account'}>
          ...
          <View key={account.id} style={styles.accountRow}>
            ...
            <View style={styles.accountCopy}>
              ...
              <Text style={styles.accountMeta}>
                {account.verificationState} · instant payout {account.supportsInstantPayout ? 'on' : 'off'}
              </Text>
            </View>
            <StatusBadge
      ...
      <PaymentGlassCard eyebrow="Preview" title="Available balance impact">
      ...
      <PaymentGlassCard eyebrow="Intents" title="Recent payout status">
        {viewModel.recentIntents.map((intent) => (
          <View key={intent.intentId} style={styles.intentBlock}>
            <View style={styles.intentHeader}>
              ...
              <StatusBadge
                tone={
                  intent.status === 'returned' || intent.status === 'failed'
                    ? 'danger'
            ...
            <DisclosureCallout disclosure={intent.disclosure} />
