/**
 * Moderator email allowlist (founder decision 2026-07-03: Supabase login +
 * email allowlist). Pure so it is unit-testable; consumed by middleware and
 * by requireModerator() in every page and server action (defense in depth).
 *
