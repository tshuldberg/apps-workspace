// Plan 25 WP-25H: the pure orchestration core under the web CallProvider (twin of
// apps/meerkat/app/(root)/data/call-provider-core.ts; byte-identical logic).
//
// Everything here is IO-free and unit-tested; the provider layers the live
// transport, media backend, and SQLite on top of these decisions. Honesty rules
