// person-identity-core.ts (Plan 52 P1/P2, WEB twin of
// apps/meerkat/app/(root)/data/person-identity-core.ts -- keep lockstep; the
// parity gate compares the shared logic line by line).
//
...
import { getIdentityRow, updateDisplayName } from './meerkat-data';
import {
  CM_PROFILES_TABLE,
