// person-view-core.ts (Plan 52 P4, WEB twin of
// apps/meerkat/app/(root)/data/person-view-core.ts -- keep lockstep; the
// parity gate compares these files line by line).
//
