...
// the CURATOR device only. This is the WEB twin of apps/meerkat/app/(root)/data/
// library-enrich-core.ts (the mobile source of truth); the two are byte-identical
// below this header, parity-locked by scripts/check-meerkat-parity.mjs.
//
