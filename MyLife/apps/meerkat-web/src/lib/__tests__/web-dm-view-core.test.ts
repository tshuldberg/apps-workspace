// Plan 21 Phase 9 (WEB twin of apps/meerkat/app/__tests__/dm-view-core.test.ts):
// the pure DM view-model helpers (dm-view-core.ts). Node-only: mapping, honest
// delivery labels, list rows, receipts-to-emit, and the ensureDirectConversation
// composition against an in-memory db.
