...
// in install + paste instructions. Node-only, no React harness. The mobile twin
// test is mirrored by this file; check-meerkat-parity byte-locks the core itself.

import { describe, it, expect } from 'vitest';
import {
  buildCommunityInviteEnvelope,
  buildContactEnvelope,
} from '../invite-envelope-core';
