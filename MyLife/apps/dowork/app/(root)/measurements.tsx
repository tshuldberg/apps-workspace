        ...
        <WorkoutHero
          ...
          trailing={
            <Pressable onPress={() => setShowComposer(true)} style={styles.headerAction}>
              <MaterialSymbol name="add_circle" size={18} color={DW_ACCENT_LIGHT} />
              <Text style={styles.headerActionText}>Log New</Text>
            </Pressable>
          }
        />
        ...
        <GlassPanel style={styles.heroPanel} intensity={50}>
          ...
          <Svg width="100%" height={190} viewBox="0 0 320 170">
            ...
            <Polyline
              points={chartPoints}
              fill="none"
              stroke={selectedType === 'body_fat' ? WK_CATEGORY_COLORS.hypertrophy : DW_ACCENT}
              strokeWidth={4}
              strokeLinecap="round"
            ...
            {chartEntries.map((entry, index) => {
              ...
              return (
                <Circle
                  ...
                  fill={index === chartEntries.length - 1 ? DW_ACCENT_LIGHT : '#F4EEE8'}
                />
              );
            })}
          </Svg>
      ...
      <Modal visible={showComposer} animationType="slide" transparent>
        <View style={styles.modalScrim}>
          <View style={styles.modalCard}>
            ...
            <WorkoutPrimaryButton label="Save Entry" onPress={handleSave} />
          </View>
        </View>
      </Modal>
    </>
