    ...
    <>
      <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
        <WorkoutHero
          ...
          trailing={
            <Pressable onPress={() => setShowComposer(true)} style={styles.headerAction}>
              <MaterialSymbol name="photo_camera" size={18} color={DW_ACCENT_LIGHT} />
              <Text style={styles.headerActionText}>Add Photo</Text>
            </Pressable>
          }
        />
        ...
        <GlassPanel style={styles.panel}>
          <View style={styles.rowBetween}>
            ...
            <Pressable onPress={() => setCompareMode((value) => !value)} style={styles.comparePill}>
              <MaterialSymbol name="photo_camera" size={16} color={DW_ACCENT_LIGHT} />
        ...
        {!photos.length ? (
          <GlassPanel style={styles.emptyPanel}>
            <MaterialSymbol name="photo_camera" size={22} color={DW_ACCENT_LIGHT} />
      ...
      <Modal visible={showComposer} animationType="slide" transparent>
        <View style={styles.modalScrim}>
          <View style={styles.modalCard}>
            ...
            <WorkoutPrimaryButton label="Use Camera" onPress={handleLaunchCamera} />
            <Pressable onPress={handleLaunchLibrary} style={styles.secondaryButton}>
