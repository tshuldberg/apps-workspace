...
import { DW_ACCENT, DW_ACCENT_LIGHT, DW_SURFACES } from './theme/tokens';
...
function getRecoveryColor(score: number): string {
  // Body heatmap is a category/semantic use - keep WK category colors.
  if (score <= 30) return WK_CATEGORY_COLORS.hypertrophy;
  if (score <= 70) return DW_ACCENT_LIGHT;
    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      <WorkoutHero
        ...
        trailing={
          <View style={styles.legendRow}>
            ...
            <View style={[styles.legendDot, { backgroundColor: DW_ACCENT_LIGHT }]} />
      ...
      {entries.length === 0 ? (
        <GlassPanel style={styles.emptyPanel}>
          <MaterialSymbol name="monitor_heart" size={24} color={DW_ACCENT_LIGHT} />
...
const styles = StyleSheet.create({
  ...
  // satisfy import - DW_ACCENT used in conditional surfaces below
  _accent: { color: DW_ACCENT },
});
