...
export default function CreateProgramScreen() {
  ...
  const saveProgram = () => {
    ...
    try {
      ...
      router.replace(`/(root)/program/${planId}` as never);
    } catch (error) {
      ...
      <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
        <WorkoutRouteHeader
          ...
          right={(
            <Pressable onPress={saveProgram} style={styles.saveButton}>
              <MaterialSymbol name="check_circle" size={18} color={DW_ACCENT_LIGHT} />
            </Pressable>
          )}
        />
        ...
        <View style={styles.body}>
          <View style={styles.heroBlock}>
            <SectionLabel accent={DW_ACCENT_LIGHT}>Build Your Program</SectionLabel>
          ...
          <GlassPanel style={styles.identityCard}>
            <SectionLabel accent={DW_ACCENT_LIGHT}>Program Identity</SectionLabel>
            <TextInput
              value={name}
          ...
          <View style={styles.stepperRow}>
            <GlassPanel style={styles.stepperCard}>
              <SectionLabel accent={DW_ACCENT_LIGHT}>Weeks</SectionLabel>
            ...
            <GlassPanel style={styles.stepperCard}>
              <SectionLabel accent={DW_ACCENT_LIGHT}>Days / Week</SectionLabel>
              <View style={styles.stepperControls}>
          ...
          <GlassPanel style={styles.coverCard}>
            <View style={styles.coverHeader}>
              <View>
                <SectionLabel accent={DW_ACCENT_LIGHT}>Cover Art</SectionLabel>
          ...
          <View style={styles.builderHeader}>
            <View>
              <SectionLabel accent={DW_ACCENT_LIGHT}>Weekly Template</SectionLabel>
              <RNText style={styles.builderTitle}>Module builder</RNText>
            </View>
            <Pressable onPress={applyWeekOneToAll} style={styles.applyPill}>
              <MaterialSymbol name="check_circle" size={14} color={DW_ACCENT_LIGHT} />
                ...
                >
                  ...
                  >
                    <MaterialSymbol
                      ...
                      size={18}
                      color={isRest ? 'rgba(214, 195, 181, 0.42)' : DW_ACCENT_LIGHT}
                    />
                  </View>
      ...
      >
        <View style={styles.modalBackdrop}>
          ...
          <View style={styles.sheetCard}>
            ...
            <SectionLabel accent={DW_ACCENT_LIGHT}>Assign Workout</SectionLabel>
...
const styles = StyleSheet.create({
  ...
  applyPill: {
    ...
    alignItems: 'center',
    gap: 6,
    backgroundColor: withAlpha(DW_ACCENT_LIGHT, '14'),
  },
  applyPillText: {
    fontFamily: WK_FONTS.medium,
    fontSize: 11,
  ...
  dayIconAssigned: {
    backgroundColor: withAlpha(DW_ACCENT_LIGHT, '16'),
  },
  dayTitle: {
