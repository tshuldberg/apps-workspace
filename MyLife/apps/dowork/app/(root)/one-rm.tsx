    ...
    <Pressable onPress={onPress} style={styles.exerciseRow}>
      ...
      >
        <MaterialSymbol
          ...
          size={18}
          color={selected ? DW_ACCENT_LIGHT : 'rgba(214, 195, 181, 0.62)'}
        />
      </View>
    </Pressable>
  );
      ...
      <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
        <WorkoutHero
          ...
          trailing={
            <View style={styles.heroBadge}>
              <MaterialSymbol name="emoji_events" size={18} color={DW_ACCENT_LIGHT} />
            </View>
          }
        />
        ...
        <GlassPanel style={styles.panel}>
          <View style={styles.rowBetween}>
            ...
            >
              <MaterialSymbol name="menu_book" size={16} color={DW_ACCENT_LIGHT} />
              <Text style={styles.secondaryButtonLabel}>
                {selectedExercise ? 'Change' : 'Select'}
              </Text>
            </Pressable>
          </View>
...
const styles = StyleSheet.create({
  ...
  secondaryButton: {
    ...
    borderWidth: 1,
    borderColor: 'rgba(255, 139, 51, 0.24)',
  },
