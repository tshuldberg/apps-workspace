...
type GradientButtonVariant = 'primary' | 'secondary' | 'danger' | 'accent';
...
export function GradientButton({
  ...
  if (variant === 'accent') {
    return (
      <Pressable onPress={onPress} style={styles.accent}>
        <Text style={styles.accentText}>{title}</Text>
      </Pressable>
    );
  }

  const grad = variant === 'danger' ? DANGER_GRADIENT : RECIPES_CTA_GRADIENT;
